                          ...
                          <div className="datapage-count">
                            ...
                            <div className="datapage-counter-count">
                              <h4>
                                ...
                                <CountUp end={350} duration={10} formattingFn={formatNumber} />
                              </h4>
                              {/* <CounterAnimation
                                isVisible={isVisible}
                      ...
                      <div className="col-md-6 col-sm-6">
                        <div className="datapage-counter-sec">
                          <div className="datapage-count">
                            ...
                            <div className="datapage-counter-count">
                              <h4>
                                <CountUp end={400} duration={10} formattingFn={formatNumber} />
                              </h4>
                      ...
                      <div className="col-md-6 col-sm-6">
                        <div className="datapage-counter-sec">
                          <div className="datapage-count">
                            ...
                            <div className="datapage-counter-count">
                              <h4>
                                <CountUp end={50} duration={10} formattingFn={formatNumber} />
                              </h4>
