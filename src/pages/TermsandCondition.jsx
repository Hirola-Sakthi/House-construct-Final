...
import TCbanner from "../components/termsandcondition/TCbanner";
import { Link } from "react-router-dom";
import TCcontent from "../components/termsandcondition/TCcontent";
...
const TermsandCondition = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Terms & Conditions | House Construct</title>
        <meta
          name="description"
          content="Read House Construct's Terms & Conditions to understand our guidelines for website usage. Learn about your responsibilities and rights when engaging with our services."
          data-rh="true"
        />
      </Helmet>
      <Modal
