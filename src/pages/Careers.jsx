...
const Careers = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>
          Join the Team at House Construct | Career Opportunities in
          Construction
        </title>
        <meta
          name="description"
          content="Explore rewarding career opportunities at House Construct, a leading construction company. Join our team of skilled professionals and build your future with us."
          data-rh="true"
        />
      </Helmet>
      <Modal
