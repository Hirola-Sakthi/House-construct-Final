...
const Home = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    // Check if there is a message in the URL parameters
    const params = new URLSearchParams(location.search);

    const msgParam = params.get("msg");
    if (msgParam && !toastShown) {
      setMessage(msgParam);
  ...
  return (
    <>
      <Helmet>
        <title>
          Best house construction company in bangalore | House Construct
        </title>
        <meta
          name="description"
          content="House construct is a best house construction company in Bangalore and also Top house construction contractors Bangalore will do best interior design renovation works"
          data-rh="true"
        />
      </Helmet>
     <div id="home" className="hidden-div-for-home"></div>
      ...
      <HomeBlogs />
      <Whatsapp />
      <Footer setSelectedCityFromFooter={setSelectedCityFromFooter} />
      {/* <Ourservices /> */}
      {/* <Besthome /> */}
    </>
  );
