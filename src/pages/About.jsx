...
const About = () => {
  ...
  return (
    <>
    <Helmet>
      <title>About Us | House Construction Company in Bangalore | House Construct</title>
      <meta name='description' content='One of the leading house construction company in Bangalore We have experience of over 20 years in home and commercial construction etc' data-rh="true" />
    </Helmet>
    <Modal
        title=""
        open={visibleModal}
