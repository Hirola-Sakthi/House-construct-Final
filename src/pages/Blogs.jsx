...
const Blogs = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Blogs | Home construction design in Bangalore| House Construct
        </title>
        <meta
          name="description"
          content="Explore our blog page for insightful articles on home construction design. Find inspiration and expert tips to enhance your homes aesthetic and functionality with House Construct."
          data-rh="true"
        />
      </Helmet>
